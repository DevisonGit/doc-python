...
# pode chamar somete por posição, se chamarmos por nome gera uma exceção
def pos_only_arg(arg, /):
    print(arg)

# podemos chamar somente pelo nome se chamarmos por posição gera uma exçeção
def kwd_only_arg(*, arg):
    print(arg)

# combinandos os estilos
